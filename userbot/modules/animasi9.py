...
@joo_cmd(pattern="Phe(?: |$)(.*)")
async def _(event):
    xx = await edit_or_reply(event, f"**ga usah sok keras deh gblk**")
    sleep(2)
    await xx.edit("**muka lu kek asbak rental ps**")
    sleep(1)
    await xx.edit("**idih najis**")
    sleep(1)
    await xx.edit("**gausah so keras ya dekku**")
...
async def _(event):
    ...
    sleep(1)
    await xx.edit("**ga ngaruh di rl bego**")


@joo_cmd(pattern="jawa(?: |$)(.*)")
async def _(event):
