...
async def locks(event):
    ...
    try:
        ...
        await event.edit(f"`Mampus Anak Anjing Gua Kunci {what} Obrolan Ini`")
...
async def rem_locks(event):
    ...
    try:
        ...
        await event.edit(
            f"`Mohon Maaf, Apakah Anda Mempunyai Izin Melakukan Itu Disini ?`\n**Kesalahan:** {str(e)}")
        return
